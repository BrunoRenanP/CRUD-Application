...
public class ControllerPedidoItem {
	...
	@RequestMapping(value = "/deletaPedidoItem/{id}",
			method = RequestMethod.DELETE,
			consumes = MediaType.APPLICATION_JSON_VALUE,
			produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<PedidoItemDTO> deletaPedidoItemPeloId(@PathVariable UUID id) {
		try {
			return new ResponseEntity<PedidoItemDTO>(pedidoItemService.deletaPedidoItemPeloId(id), HttpStatus.OK);
